...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $ionicLoading,$http, $ionicPopup, $core, $account, $rootScope) {
  ...
  $scope.signout = function(){
    $ionicPopup.confirm({
      ...
      $scope.user = null;
      if (!$scope.$$phase) $scope.$apply();
      console.log($scope.isLoggedIn, $account.isLoggedIn);
    }
    });
}
...
.controller('browseQuestionsController', function($scope,$stateParams,$http,$core,$ionicLoading,$sce,$state, $ionicPopup, $file){
