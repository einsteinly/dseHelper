...
<div>
    ...
    <h1 id='head2' style="display:none"><i class='fa fa-exclamation-triangle'></i> AUTHENTICATION FAILED<br></h1>
    </div>
    <center>
    <h2> Wrong user name and password combination.</h2>
    <a class='btn-danger btn-lg btn' href="/login"> Try again</a><br><br>
    </center>
</div>
